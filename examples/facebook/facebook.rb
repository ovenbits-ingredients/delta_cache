...
## Redis
TimeCache::RedisDB.connection = Redis.new(
  :host => "127.0.0.1"
)
TimeCache.db = TimeCache::RedisDB.new

## Cassandra
# TimeCache::CassandraDB.connection = Cassandra.new(
#   'TimeCache',
#   '127.0.0.1:9160',
#   :retries => 3
# )
# TimeCache.db = TimeCache::CassandraDB.new

## Logging
# TimeCache.logger = Logger.new(STDOUT, Logger::DEBUG)
